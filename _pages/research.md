...
{% include base_path %}
 Replicability of a journal: a comprehensive overview (joint with H. Kingi, F. Stanchi and L.Vilhuber) [[<span style="color:#007CBB">Slides</span>]] (../files/bitss_slide.pdf) {% include base_path %}
